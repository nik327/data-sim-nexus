...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative px-6 md:px-12 pt-16 pb-24 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          >
            ...
            <span className="text-gradient-warm text-6xl md:text-9xl">&</span>
          ...
          <motion.div {...fadeUp(4)} className="grid md:grid-cols-2 gap-5 max-w-3xl">
            ...
            <Link
              to="/academy"
              className="group relative p-7 rounded-3xl bg-card shadow-lg shadow-primary/5 hover:shadow-primary/10 transition-all duration-300 text-left"
            >
              <div className="absolute top-0 left-0 w-full h-1 rounded-t-3xl bg-gradient-to-r from-primary/60 to-primary/20 opacity-0 group-hover:opacity-100 transition-opacity" />
              ...
              <span className="inline-flex items-center gap-2 text-xs font-mono text-primary font-semibold group-hover:gap-3 transition-all">
                Begin Training <ArrowRight className="h-3.5 w-3.5" strokeWidth={1.5} />
              </span>
            </Link>
            ...
            <Link
              to="/internship"
              className="group relative p-7 rounded-3xl bg-card shadow-lg shadow-accent/5 hover:shadow-accent/10 transition-all duration-300 text-left"
            >
              <div className="absolute top-0 left-0 w-full h-1 rounded-t-3xl bg-gradient-to-r from-accent/60 to-accent/20 opacity-0 group-hover:opacity-100 transition-opacity" />
              <div className="flex items-center gap-3 mb-4">
              ...
              <span className="inline-flex items-center gap-2 text-xs font-mono text-accent font-semibold group-hover:gap-3 transition-all">
                Take Assessment <ArrowRight className="h-3.5 w-3.5" strokeWidth={1.5} />
              </span>
            </Link>
          </motion.div>
          ...
          {role !== "visitor" && (
            <motion.div {...fadeUp(5)} className="mt-6">
              <Link
                to="/hub"
                className="inline-flex items-center gap-2 px-5 py-2.5 border border-border/50 text-foreground font-medium rounded-2xl text-sm hover:bg-secondary/60 transition"
              >
                <TrendingUp className="h-4 w-4 text-primary" strokeWidth={1.5} /> Continue to Work Hub
      ...
      {/* Stats */}
      <section className="px-6 md:px-12 py-16 border-t border-border/30 bg-card/30">
        <div className="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8">
          {stats.map((s, i) => (
            ...
            >
              <s.icon className="h-5 w-5 text-primary mx-auto mb-3 group-hover:scale-110 transition-transform" strokeWidth={1.5} />
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {tracks.map((t, i) => (
              <motion.div
                ...
                className="relative p-6 rounded-3xl bg-card shadow-lg shadow-primary/3 hover:shadow-primary/8 transition-all duration-300 group"
              >
                <t.icon className="h-9 w-9 text-primary mb-4 group-hover:scale-110 transition-transform" strokeWidth={1.5} />
                ...
                <span className="inline-block text-[10px] font-mono uppercase tracking-wider text-primary/70 bg-primary/5 px-2.5 py-1 rounded-full">
                  {t.level}
                </span>
              </motion.div>
            ))}
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link
                to="/academy"
                className="inline-flex items-center gap-2 px-6 py-3 bg-primary text-primary-foreground font-semibold rounded-2xl hover:opacity-90 transition glow-sage"
              >
                <GraduationCap className="h-4 w-4" strokeWidth={1.5} /> Start Academy
              </Link>
              <Link
                to="/internship"
                className="inline-flex items-center gap-2 px-6 py-3 border border-accent/40 text-accent font-semibold rounded-2xl hover:bg-accent/5 transition"
              >
                <Briefcase className="h-4 w-4" strokeWidth={1.5} /> Take Internship Test
              </Link>
            </div>
          </motion.div>
        </div>
      ...
      <footer className="px-6 md:px-12 py-8 border-t border-border/30">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          ...
          <span className="text-[10px] font-mono text-muted-foreground">
            SUSTAINABLE LOGISTICS // BIO-TECH DIVISION
          </span>
        </div>
      </footer>
    </div>
